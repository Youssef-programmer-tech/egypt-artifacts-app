...
our %config = (
  ...
  CPPFLAGS => [ "-DANDROID -I/root/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include -I/root/egypt-apk/.buildozer/android/platform/build-arm64-v8a_armeabi-v7a/build/python-installs/egyptartifacts/arm64-v8a/include/python3.1" ],
  CPPINCLUDES => [  ],
